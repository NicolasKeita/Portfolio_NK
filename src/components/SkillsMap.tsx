    ...
    <div className="relative w-full max-w-7xl mx-auto px-4 pt-4 pb-4 space-y-6">
      <div
        className={`
          ...
          bg-slate-950 bg-[radial-gradient(circle_at_center,rgba(34,211,238,0.1),rgba(59,130,246,0.03)_40%,transparent_70%)]
          ...
          <div className="relative z-10 h-[520px]">
            ...
            <div className="absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 justify-center px-4">
              <button
                ...
                className={clsx(
                  'w-[clamp(180px,20vw,250px)] rounded-full border px-6 py-3 text-center backdrop-blur-2xl transition-all duration-300 ease-out',
                  isCenterHovered
