...
export function SkillsMap() {
  ...
  return (
    <div className="relative w-full max-w-7xl mx-auto px-4 pt-4 pb-4 space-y-6">
      <div className="pointer-events-none absolute inset-x-[-12%] top-[-12%] h-[500px] rounded-full bg-slate-950 bg-[radial-gradient(circle_at_center,rgba(34,211,238,0.1),rgba(59,130,246,0.03)_40%,transparent_70%)] md:blur-2xl" />
