      ...
      <div className="max-w-[1280px] mx-auto px-6 sm:px-8 py-0 md:py-1 min-h-[20vh] flex flex-col justify-center">
        <div className="w-full">
          <div className="flex flex-col justify-center">
            ...
            <motion.p
              className="font-display font-semibold text-cyan-200 leading-snug max-w-[620px] mb-2 p-2 pl-4 border-l-4 border-amber bg-slate-950/45 backdrop-blur-xl rounded-r-lg shadow-[0_12px_45px_rgba(2,6,23,0.24)]"
