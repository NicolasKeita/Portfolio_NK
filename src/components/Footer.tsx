...
export function Footer() {
  ...
  return (
    <footer className="relative bg-[#050816]/72 backdrop-blur-xl text-slate-400 text-center py-12 px-8 before:content-[''] before:absolute before:top-0 before:left-1/2 before:-translate-x-1/2 before:w-[min(1100px,calc(100%-4rem))] before:h-[1px] before:bg-[linear-gradient(90deg,transparent,rgba(34,211,238,0.32),rgba(129,140,248,0.22),transparent)]">
